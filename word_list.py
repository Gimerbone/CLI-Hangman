word_list = [
    "able", "about", "abruptly", "absurd", "abyss", "account", "acid", "across", "act", "addition",
    "adjustment", "advertisement", "affix", "after", "again", "against", "agreement", "air", "all",
    "almost", "among", "askew", "avenue", "awkward", "axiom", "azure", "bagpipes", "bandwagon",
    ...
    "fishhook", "fixable", "fjord", "flapjack", "flopping", "fluffiness", "flyby", "foxglove", 
    ...
    "luxury", "lymph", "marquis", "matrix", "megahertz", "microwave", "mnemonic", "mystify",
    ...
    "razzmatazz", "rhubarb", "rhythm", "rickshaw", "schnapps", "scratch", "shiv", "snazzy", "sphinx",
